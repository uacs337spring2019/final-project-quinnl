(function(){
  ...
  */
  function loadOptions() {
    let url = "https://meme-maker-quinnlawson.herokuapp.com:process.env.PORT/?mode=names";
    fetch(url)
      .then(checkStatus)
  ...
  */
  function changeMeme() {
    ...
    let url = "https://meme-maker-quinnlawson.herokuapp.com:process.env.PORT/?mode=url&name=" + name;
  ...
  */
  function loadTextPointFields(name) {
    let url = "https://meme-maker-quinnlawson.herokuapp.com:process.env.PORT/?mode=textPoints&name=" + name;
  ...
  */
  function saveMeme() {
    ...
    let url = "https://meme-maker-quinnlawson.herokuapp.com:process.env.PORT/";
  ...
  */
  function showGallery() {
    ...
    let url = "https://meme-maker-quinnlawson.herokuapp.com:process.env.PORT/?mode=memes";
    fetch(url)
      .then(checkStatus)
      .then(function(responseText) {
        ...
        for(let i = 0; i < memes.length; i++) {
          ...
          url = "https://meme-maker-quinnlawson.herokuapp.com:process.env.PORT/?mode=textPoints&name=" + fields[0];
          fetch(url)
            .then(checkStatus)
            .then(function(responseText2) {
              let textPoints = JSON.parse(responseText2).textPoints;

              url = "https://meme-maker-quinnlawson.herokuapp.com:process.env.PORT/?mode=url&name=" + fields[0];
              fetch(url)
                .then(checkStatus)
