(function(){
  ...
  */
  function loadOptions() {
    let url = "http://localhost:3000?mode=names";
    fetch(url)
      .then(checkStatus)
  ...
  */
  function changeMeme() {
    ...
    let url = "http://localhost:3000?mode=url&name=" + name;
  ...
  */
  function loadTextPointFields(name) {
    let url = "http://localhost:3000?mode=textPoints&name=" + name;
  ...
  */
  function showGallery() {
    ...
    let url = "http://localhost:3000?mode=memes";
    fetch(url)
      .then(checkStatus)
      .then(function(responseText) {
        ...
        for(let i = 0; i < memes.length; i++) {
          ...
          url = "http://localhost:3000?mode=textPoints&name=" + fields[0];
          fetch(url)
            .then(checkStatus)
            .then(function(responseText2) {
              let textPoints = JSON.parse(responseText2).textPoints;

              url = "http://localhost:3000?mode=url&name=" + fields[0];
              fetch(url)
                .then(checkStatus)
