(function(){
  ...
  */
  function loadOptions() {
    let url = "http://final-project-quinnl.herokuapp.com?mode=names";
    fetch(url)
      .then(checkStatus)
  ...
  */
  function changeMeme() {
    ...
    let url = "http://final-project-quinnl.herokuapp.com?mode=url&name=" + name;
  ...
  */
  function loadTextPointFields(name) {
    let url = "http://final-project-quinnl.herokuapp.com?mode=textPoints&name=" + name;
  ...
  */
  function saveMeme() {
    ...
    let url = "http://final-project-quinnl.herokuapp.com";
  ...
  */
  function showGallery() {
    ...
    let url = "http://final-project-quinnl.herokuapp.com?mode=memes";
    fetch(url)
      .then(checkStatus)
      .then(function(responseText) {
        ...
        for(let i = 0; i < memes.length; i++) {
          ...
          url = "http://final-project-quinnl.herokuapp.com?mode=textPoints&name=" + fields[0];
          fetch(url)
            .then(checkStatus)
            .then(function(responseText2) {
              let textPoints = JSON.parse(responseText2).textPoints;

              url = "http://final-project-quinnl.herokuapp.com?mode=url&name=" + fields[0];
              fetch(url)
                .then(checkStatus)
